...
public class EmployeeRestController {
	...
	public Employee updateEmployee(
			@RequestBody @Validated UpdateEmployeeRequest employee, 
	...
	public Employee patchEmployee(
			@RequestBody Map<String, Object> employee, @PathVariable String identity) {
		return empSrv.patchEmployee(employee, identity);
	}

	@DeleteMapping("{identity}")
	public Employee deleteEmployeeByIdentity(
			@PathVariable @TcKimlikNo String identity) {
